...
%{
The function returns the absolute threshold in dB on the bin (Hz) frequency scale 
and the frequency band (Bark) frequency scale, where both are scaled relative to p0_level_dB.
%}
common;
...
% the formula for Absolute Threshold of Hearing
...
bottom_bin = 1;
%map the threshold from Hz to Bark
    for i = 1:top_band
